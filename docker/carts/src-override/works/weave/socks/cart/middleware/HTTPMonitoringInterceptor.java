...
public class HTTPMonitoringInterceptor implements HandlerInterceptor {
    ...
    // required=false: this app uses MongoDB, not JPA, so Spring Data REST
    // has no reason to guarantee this bean exists. Whatever combination of
    // versions this was originally built against apparently registered it
    // unconditionally; the versions Spring Boot 2.0.4 resolves today don't,
